export const location = [
   [
      { id: 1, title: "Address:", name: "address" },
      { id: 3, title: "State/County: ", name: "region" },
   ],
   [
      { id: 2, title: "City:", name: "city" },
      { id: 4, title: "Zip:", name: "zipCode" },
   ],
...
export const property = [
   ...
   [
      ...
      { id: 6, title: "Bathrooms:", name: "bath" },
      { id: 7, title: "Garage:", name: "garage" },
      // { id: 8, title: "Garage size:", name: "" },
   ],
